...
subjects_string=`cat /hpc/scratch/your_account/sing/HCP/subjects/subjects-retest.csv`
...
work_dir_abs_path="/hpc/scratch/your_account/sing/work_dir/fmriprep_working_dir_rt_$participant_id"
...
bids_path="/scratch/data/HCP-RT"

out_path="/scratch/data/HCP-RT/derivatives/fmriprep"

work_dir_path="/scratch/work_dir/fmriprep_working_dir_rt_$participant_id"

license_path="/scratch/fs_licence/license.txt"

fs_sub_dir="/scratch/data/HCP-RT/derivatives/freesurfer/"
